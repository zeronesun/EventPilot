    ...
    >
      ...
      >
        ...
        <el-form-item label="目标达成">
          <el-input
            v-model="reviewForm.goal_achievement"
            type="textarea"
            :rows="3"
            placeholder="请描述目标达成情况"
          />
        </el-form-item>
        <el-form-item label="流程执行">
          <el-input
            v-model="reviewForm.process_execution"
            type="textarea"
            :rows="3"
            placeholder="请描述流程执行情况"
          />
        </el-form-item>
        <el-form-item label="成本控制">
          <el-input
            v-model="reviewForm.cost_control"
            type="textarea"
            :rows="3"
            placeholder="请描述成本控制情况"
          />
        </el-form-item>
        <el-form-item label="客户反馈">
          <el-input
            v-model="reviewForm.customer_feedback"
            type="textarea"
            :rows="3"
            placeholder="请描述客户反馈"
          />
        ...
        <el-form-item label="团队协作">
          <el-input
            v-model="reviewForm.team_collaboration"
            type="textarea"
            :rows="3"
            placeholder="请描述团队协作情况"
          />
        </el-form-item>
        <el-divider content-position="left">
          总结与改进
        ...
        <el-form-item label="行动项">
          <el-input
            v-model="reviewForm.action_items"
            type="textarea"
            :rows="3"
            placeholder="请列出后续行动项"
          />
        </el-form-item>
      </el-form>
      <template #footer>
      ...
      <template v-if="currentReview">
        ...
        >
          ...
          <el-descriptions-item label="状态">
            <el-tag :type="getStatusTag(currentReview.status)">
        ...
        >
          <el-descriptions-item label="目标达成">
            <div style="white-space: pre-wrap">
              {{ currentReview.goal_achievement || '未填写' }}
            </div>
          </el-descriptions-item>
          <el-descriptions-item label="流程执行">
            <div style="white-space: pre-wrap">
              {{ currentReview.process_execution || '未填写' }}
            </div>
          </el-descriptions-item>
          <el-descriptions-item label="成本控制">
            <div style="white-space: pre-wrap">
              {{ currentReview.cost_control || '未填写' }}
            </div>
          </el-descriptions-item>
          <el-descriptions-item label="客户反馈">
            <div style="white-space: pre-wrap">
              {{ currentReview.customer_feedback || '未填写' }}
            </div>
          </el-descriptions-item>
          <el-descriptions-item label="团队协作">
            <div style="white-space: pre-wrap">
              {{ currentReview.team_collaboration || '未填写' }}
            </div>
          </el-descriptions-item>
        </el-descriptions>
        ...
        >
          ...
          <el-descriptions-item label="行动项">
            <div style="white-space: pre-wrap">
              {{ currentReview.action_items || '未填写' }}
            </div>
          </el-descriptions-item>
        </el-descriptions>
      </template>
