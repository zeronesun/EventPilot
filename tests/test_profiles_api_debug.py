...
if r.status_code == 200 and len(r.json()) > 0:
    ...
    if profile_id:
        ...
        # 8. 测试综合评估
        print(f"\n8. 测试 /profiles/{profile_id}/comprehensive_assessment/:")
